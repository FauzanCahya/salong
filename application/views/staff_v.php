        ...
        <div class="col-md-12">
            ...
            <div>
                <ul class="nav nav-tabs nav-justified">
                    <li class="active"><a href="#tabs-10" data-toggle="tab" aria-expanded="true">Staff List</a></li>
                    <li class=""><a href="#tabs-11" data-toggle="tab" aria-expanded="false">Daily Working Hours</a></li>
                    <li class=""><a href="#tabs-12" data-toggle="tab" aria-expanded="false">Commision Profile</a></li>
                    <li class=""><a href="#tabs-13" data-toggle="tab" aria-expanded="false">Staff Commission</a></li>
                </ul>
                            ...
                            <table class="table table-striped table-bordered datatable-extended">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 10%;">Login Acces</th>

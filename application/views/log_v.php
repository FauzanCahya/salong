<div class="page-bar">
                            <ul class="page-breadcrumb">
                                <li>
                                    <a href="<?=base_url();?>front_c">Home</a>
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase">MY TRANSAKSI</span>
                                        </div>
                                        <ul class="nav nav-tabs">
                                            <li class="active">
                                                <a href="#portlet_comments_1" data-toggle="tab" aria-expanded="true">  </a>
                                            </li>
